...
// ══════════════════════════════════════════════════════════════════════════════
// DATA - 8 Modules with Your Color Palette
// ══════════════════════════════════════════════════════════════════════════════
...
const modules = [
  { 
    ...
    bgColor: "#f3f0ff",
    borderColor: "#e9d5ff",
    example: "Can spell age-appropriate words?" 
  },
  { 
    id: 2, 
    label: "Reading", 
    ...
    bgColor: "#fff7ed",
    borderColor: "#fed7aa",
    example: "Comprehends grade-level texts?" 
  },
  { 
    id: 3, 
    label: "Pronunciation", 
  ...
  { 
    ...
    bgColor: "#f0fdf4",
    borderColor: "#bbf7d0",
    example: "Uses correct grammar structures?" 
  },
  { 
    id: 5, 
    label: "Writing", 
    ...
    bgColor: "#fef2f2",
    borderColor: "#fecaca",
    example: "Writes coherent paragraphs?" 
  },
  { 
    id: 6, 
    label: "Listening", 
  ...
  { 
    ...
    bgColor: "#fffbeb",
    borderColor: "#fde68a",
    example: "Uses diverse vocabulary?" 
  },
  { 
    id: 8, 
    label: "S.H.A.R.P", 
...
const trustBadges = [
  ...
  { icon: Lock, text: "Privacy Guaranteed", color: "#3b82f6" },
  { icon: Users, text: "15,000+ Families", color: "#8b5cf6" },
  { icon: BarChart3, text: "86% Find Gaps", color: "#f59e0b" },
];

const faqs = [
  {
    q: "Is this really a free health check?",
    a: "Yes! Completely free. We believe every child deserves to know their English skill baseline before considering competitions or coaching.",
  },
  {
    q: "How is this different from a competition?",
    a: "This is a diagnostic health check, not a competition. It's like a medical checkup for English skills—identifying strengths and areas needing attention.",
  },
  {
    q: "What do we receive after the assessment?",
    a: "You'll get a detailed skill report showing your child's performance across all 8 modules, with personalized recommendations for improvement or competition readiness.",
  },
  {
    q: "How long does it take?",
    a: "10-15 minutes to complete all 8 modules. Your child can take breaks and resume anytime within 24 hours.",
  },
  {
    q: "Is our data safe?",
    a: "Absolutely. All data is encrypted, never shared, and automatically deleted after 90 days. We're privacy-first.",
  },
];
...
const statsData = [
  { value: "15,000+", label: "Families Assessed" },
  { value: "8 Modules", label: "Skill Areas Tested" },
  { value: "86%", label: "Discover Hidden Gaps" },
...
// ══════════════════════════════════════════════════════════════════════════════
// HERO SECTION - Updated Tone: "Skill Health Check"
// ══════════════════════════════════════════════════════════════════════════════
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-8 animate-slideInUp">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-md border border-purple-300/30 rounded-full px-5 py-2.5 text-purple-100 shadow-lg">
            ...
            <span className="font-bold text-sm tracking-wide">FOR PARENTS OF STUDENTS GRADE 1-10</span>
          </div>
        </div>

        {/* Main Heading - Tone Changed */}
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-purple-100 max-w-5xl mx-auto leading-relaxed">
            ...
            <span className="relative inline-block">
              <span className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-black px-4 py-2 rounded-xl shadow-lg">
                English Skill Health Check
              </span>
            </span>
            {" "}to discover your child's strengths and areas needing attention across all 8 language skills
          </p>
        </div>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-purple-200 text-sm sm:text-base">
                Comprehensive skill mapping aligned with CBSE, ICSE & International Standards
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-white text-center sm:text-left">
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <div>
                ...
                <div className="text-emerald-100 text-sm font-medium">Diagnostic Health Check</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <div>
                ...
                <div className="text-emerald-100 text-sm font-medium">Quick Registration</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <div>
                <div className="font-black text-2xl sm:text-3xl">INSTANT</div>
                <div className="text-emerald-100 text-sm font-medium">Skill Report + Recommendations</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-8 animate-slideInUp" style={{ animationDelay: '0.4s' }}>
          <div className="inline-flex items-center gap-2 bg-orange-500/20 backdrop-blur-sm border border-orange-300/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-orange-100 text-sm font-semibold">
              <span className="font-black text-orange-300 animate-countUp">{liveCount}</span> families checked today
            </span>
          </div>
        </div>

        {/* CTA Button - Updated Copy */}
        <div className="flex justify-center animate-slideInUp" style={{ animationDelay: '0.5s' }}>
          ...
          >
            <span className="flex items-center justify-center gap-3">
              <BarChart3 size={28} className="group-hover:animate-bounce" strokeWidth={2.5} />
        ...
        <p className="text-center text-purple-300 text-sm sm:text-base mt-4 font-medium animate-slideInUp" style={{ animationDelay: '0.6s' }}>
          ✨ 15,000+ families discovered their child's skill baseline • Results in 10-15 minutes
        </p>
      ...
      <div className="bg-white rounded-3xl shadow-2xl border-2 border-purple-100 p-6 sm:p-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-gray-900 mb-2">
            Start Your Child's Skill Health Check
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <label className="flex items-center gap-3 mt-3 cursor-pointer group">
                ...
                <span className="text-sm text-gray-700 font-medium group-hover:text-gray-900"><MessageCircle size={14} className="inline mr-1 text-green-600" />Send results on WhatsApp</span>
              </label>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="text-sm text-gray-800 leading-relaxed">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2"><Check size={16} className="text-green-600 flex-shrink-0 mt-0.5" strokeWidth={3} /><span>Your child completes <strong>8-module diagnostic</strong> (10-15 mins)</span></li>
                  <li className="flex items-start gap-2"><Check size={16} className="text-green-600 flex-shrink-0 mt-0.5" strokeWidth={3} /><span><strong>Instant module-wise scores</strong> after completion</span></li>
                  <li className="flex items-start gap-2"><Check size={16} className="text-green-600 flex-shrink-0 mt-0.5" strokeWidth={3} /><span>Receive <strong>detailed skill report</strong> with strengths & gaps</span></li>
                  <li className="flex items-start gap-2"><Check size={16} className="text-green-600 flex-shrink-0 mt-0.5" strokeWidth={3} /><span><strong>Personalized recommendations</strong> for improvement or competition prep</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <button type="submit" disabled={submitting} className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-black text-lg px-8 py-5 rounded-2xl shadow-2xl hover:shadow-emerald-500/50 hover:scale-105 transition-all duration-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3">
            {submitting ? <><div className="w-6 h-6 border-4 border-white border-t-transparent rounded-full animate-spin" /><span>Reserving Your Spot...</span></> : <><BarChart3 size={24} strokeWidth={2.5} /><span>Start Free Health Check</span><ArrowRight size={24} strokeWidth={2.5} /></>}
          </button>

          <div className="flex items-center justify-center gap-2 text-xs sm:text-sm text-gray-500 pt-2"><Lock size={14} className="text-green-600" /><span>256-bit encrypted • Your data is safe & never shared</span></div>
        </form>
      </div>
    </div>
  );
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 pb-16 pt-12">
      <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 border-4 border-green-300 rounded-3xl p-8 sm:p-12 text-center shadow-2xl">
        ...
        <p className="text-base sm:text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Your child will complete diagnostic tests across <strong>all 8 modules</strong>. 
          You'll receive a detailed skill report with strengths and improvement areas. Good luck! 💪✨
        </p>
        ...
        <div className="bg-white border-2 border-green-200 rounded-2xl p-6 mb-8 max-w-xl mx-auto">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-center gap-3 text-base font-bold text-gray-900 bg-green-50 rounded-xl p-3">
              ...
              {form.whatsapp && <span className="bg-green-600 text-white text-xs px-2 py-1 rounded-full">+ WhatsApp</span>}
            </div>
            {form.email && (
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Everything you need to know about the health check
          </p>
        </div>
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-100 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow">
              ...
              >
                ...
                <ChevronDown size={24} className={`flex-shrink-0 text-purple-600 transition-transform duration-300 ${openIndex === i ? 'rotate-180' : ''}`} strokeWidth={2.5} />
              </button>
              
              <div className={`overflow-hidden transition-all duration-300 ${openIndex === i ? 'max-h-96' : 'max-h-0'}`}>
                <div className="px-6 pb-5 text-gray-700 leading-relaxed">{faq.a}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-12 text-center bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 rounded-2xl p-6">
          <p className="text-gray-800 font-semibold mb-3">Still have questions? We're here to help!</p>
...
export default function ParentsAssessmentPage() {
      ...
      <section id="registration-form" className="scroll-mt-24 py-16">
        {!showForm ? (
          <div className="text-center px-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-4">
              Start Your Child's English Skill Health Check
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Discover strengths and gaps across all 8 modules in just 10-15 minutes
            </p>
            <button
      ...
      <footer className="bg-gradient-to-r from-purple-900 to-pink-900 text-white py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-sm opacity-90">
            © 2025 Master of Alphabet. All rights reserved. • Made with ❤️ for Indian Families
          </p>
